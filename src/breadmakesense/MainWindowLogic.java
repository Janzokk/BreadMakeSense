...
/**
 * Logic behind the {@link MainWindowFX}. Does all the calculations and the updates of the variables.
 * 
...
public class MainWindowLogic {
	 ...
	 */
	final static int[] ITEMS_PRICE_DEFAULT = { 20, 500, 2500, 5000 };
	...
	public static boolean buyItem(byte item) {
		if (breads >= itemsPrice[item]) {
			...
			items[item]++;
			// When an items is bought the price increases
